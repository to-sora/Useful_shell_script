...
sudo DISPLAY=$VALID_DISPLAY XAUTHORITY=$XAUTH nvidia-settings   -a "[gpu:0]/GPUFanControlState=1"   -a "[fan:0]/GPUTargetFanSpeed=$fanspeed"
echo "已將 Fan 0 設定為 $fanspeed% (Display: $VALID_DISPLAY)"
