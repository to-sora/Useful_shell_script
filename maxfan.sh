...
sudo DISPLAY=$VALID_DISPLAY XAUTHORITY=$XAUTH nvidia-settings   -a "[gpu:0]/GPUFanControlState=1"   -a "[fan:0]/GPUTargetFanSpeed=95"
echo "已將 Fan 0 設定為 95% (Display: $VALID_DISPLAY)"
